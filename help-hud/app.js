...
const texts = {
  en: {
    ...
    sent: "Request sent!",
    thanks: "Thank you. A mentor will be in touch soon to help you. Please remain on the region until they contact you."
  },
  ...
  da: {
    ...
    thanks: "Tak. En mentor vil snart kontakte dig for at hjælpe dig. Bliv venligst i regionen, indtil de kontakter dig."
  },
  ...
  de: {
    ...
    thanks: "Danke. Ein Mentor wird sich bald mit Ihnen in Verbindung setzen, um Ihnen zu helfen. Bitte bleiben Sie in der Region, bis man Sie kontaktiert."
  },
  ...
  es: {
    ...
    thanks: "Gracias. Un mentor se pondrá en contacto contigo pronto para ayudarte. Por favor, permanece en la región hasta que te contacten."
  },
  ...
  fr: {
    ...
    thanks: "Merci. Un mentor vous contactera bientôt pour vous aider. Veuillez rester dans la région jusqu’à ce qu’on vous contacte."
  },
  ...
  it: {
    ...
    thanks: "Grazie. Un mentore ti contatterà presto per aiutarti. Per favore, rimani nella regione finché non ti contatta."
  },
  ...
  hu: {
    ...
    sent: "Kérés elküldve!",
    thanks: "Köszönjük. Hamarosan egy mentor felveszi veled a kapcsolatot, hogy segítsen. Kérjük, maradj a régióban, amíg kapcsolatba nem lépnek veled."
  },
  ...
  nl: {
    ...
    thanks: "Bedankt. Een mentor neemt binnenkort contact met je op om je te helpen. Blijf alsjeblieft in de regio totdat er contact is opgenomen."
  },
  ...
  pl: {
    ...
    sent: "Prośba wysłana!",
    thanks: "Dziękujemy. Mentor wkrótce skontaktuje się z Tobą, aby pomóc. Prosimy pozostać w regionie, aż się z Tobą skontaktują."
  },
  ...
  pt: {
    ...
    sent: "Pedido enviado!",
    thanks: "Obrigado. Um mentor entrará em contacto consigo em breve para ajudar. Por favor, permaneça na região até que entrem em contacto."
  },
  ...
  ru: {
    ...
    thanks: "Спасибо. Наставник скоро свяжется с вами, чтобы помочь. Пожалуйста, оставайтесь в регионе, пока с вами не свяжутся."
  },
  ...
  tr: {
    ...
    thanks: "Teşekkürler. Bir mentor size yardımcı olmak için yakında iletişime geçecek. Lütfen size ulaşana kadar bölgede kalın."
  },
  ...
  uk: {
    ...
    thanks: "Дякуємо. Незабаром ментор зв’яжеться з вами, щоб допомогти. Будь ласка, залишайтеся в регіоні, доки з вами не зв’яжуться."
  },
  ...
  zh: {
    ...
    needOne: "请至少选择一个主题。",
    sent: "请求已发送！",
    thanks: "谢谢。导师很快会联系您为您提供帮助。请在他们联系您之前留在该区域。"
  },
  ...
  ja: {
    ...
    sent: "依頼を送信しました！",
    thanks: "ありがとうございます。まもなくメンターが連絡し、サポートします。連絡があるまで、このリージョンに留まってください。"
  },
  ...
  ko: {
    ...
    sent: "요청이 전송되었습니다!",
    thanks: "감사합니다. 곧 멘토가 도와드리기 위해 연락드립니다. 연락을 받을 때까지 이 리전에서 기다려 주세요."
  }
};
...
const onLoad = () => {
  // stop listening and clean up the hidden POST form
  sink.removeEventListener("load", onLoad);
  if (resultEl) resultEl.textContent = "";
  if (f) f.remove();

  // swap the whole UI to a localized success screen
  const t = texts[lang] || texts.en;
  const appEl = document.getElementById("app");
  if (appEl) {
    appEl.innerHTML = `
    ...
    try { f.submit(); }
    catch (err) { if (DEBUG) resultEl.textContent = "❌ Network error."; }
  });
}
