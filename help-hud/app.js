...
const texts = {
  ...
  uk:{title:"Запит на допомогу ментора",instructions:"Оберіть одну чи кілька тем, у яких вам потрібна допомога.",topics:{how:"Як працює Second Life",exploring:"Дослідження світу",meeting:"Знайомства / пошук друзів",freebies:"Пошук безкоштовних речей",avatar:"Можливості аватара"},submit:"Надіслати",needOne:"Виберіть щонайменше одну тему.",sent:"Запит надіслано!"},
  zh:{title:"请求导师帮助",instructions:"请选择一个或多个需要帮助的主题。",topics:{how:"Second Life 如何运作",exploring:"探索世界",meeting:"结识他人 / 交朋友",freebies:"寻找免费物品",avatar:"化身的可能性"},submit:"提交",needOne:"请至少选择一个主题。",sent:"请求已发送！"},
  ja:{title:"メンターへの支援依頼",instructions:"支援が必要なトピックを1つ以上選択してください。",topics:{how:"Second Life の仕組み",exploring:"世界を探検する",meeting:"人と出会う／友達を見つける",freebies:"フリー品を見つける",avatar:"アバターの可能性"},submit:"送信",needOne:"少なくとも1つ選択してください。",sent:"依頼を送信しました！"},
